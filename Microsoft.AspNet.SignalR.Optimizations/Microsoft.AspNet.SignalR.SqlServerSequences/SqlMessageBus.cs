...
namespace Microsoft.AspNet.SignalR.SqlServerSequences
{
    ...
    public class SqlMessageBus : ScaleoutMessageBus
    {
        ...
        private readonly bool _executeDefaultSignalGCLogic;
            ...
            : base(resolver, configuration)
        {
            ...
            _executeDefaultSignalGCLogic = configuration.ExecuteDefaultSignalGCLogic;
        ...
        private void Initialize(object state)
        {
            ...
            for (var i = 0; i < _configuration.TableCount; i++)
            {
                ...
                _trace.TraceVerbose("{0} ExecuteDefaultSignalGCLogic {1}", 
                                            tableName,
                                            (_executeDefaultSignalGCLogic ? "is active": "is disabled")
                                            );
                var stream = new SqlStream(streamIndex, _connectionString, tableName, _trace, _dbProviderFactory, _executeDefaultSignalGCLogic);
