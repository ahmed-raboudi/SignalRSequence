...
namespace Microsoft.AspNet.SignalR.SqlServerSequences
{
    internal class SqlStream : IDisposable
    {
        ...
        public SqlStream(int streamIndex, string connectionString, string tableName, TraceSource traceSource, IDbProviderFactory dbProviderFactory, bool executeDefaultSignalGCLogic)
        {
            ...
            _sender = new SqlSender(connectionString, tableName, _trace, dbProviderFactory, executeDefaultSignalGCLogic);
